...
gldelf_i386_id_note_section_size (bfd *abfd,
...
static bfd_boolean
gldelf_i386_write_build_id_section (bfd *abfd)
{
...
gldelf_i386_after_open (void)
{
  ...
  if (link_info.emit_note_gnu_build_id)
	...
	{
	  size = gldelf_i386_id_note_section_size (abfd, &link_info);
	  if (size == 0)
	    {
	      ...
	      if (s != NULL && bfd_set_section_alignment (abfd, s, 2))
		{
		  ...
		  t->after_write_object_contents
		    = &gldelf_i386_write_build_id_section;
...
OUTPUT_ARCH(i386)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"/home/cpt/opt/cross/i686-elf/lib\");\n\
SECTIONS\n\
{\n\
  /* Read-only sections, merged into text segment: */\n\
