(define_conditions [
  ...
  (-1 "(TARGET_READ_MODIFY_WRITE || optimize_insn_for_size_p ())
   ...
   && ix86_match_ccmode (peep2_next_insn (3),
			 ...
			 ? CCGOCmode : CCNOmode)")
  (-1 "((TARGET_VZEROUPPER && !SIBLING_CALL_P (insn)) && (Pmode == SImode)) && ( reload_completed)")
  (-1 "TARGET_SSE
  ...
  (-1 "TARGET_AVX2 && ix86_binary_operator_ok (PLUS, V16HImode, operands)")
  ...
  (-1 "find_regno_note (insn, REG_UNUSED, REGNO (operands[0]))
   && can_create_pseudo_p ()")
  (-1 "(TARGET_VZEROUPPER && SIBLING_CALL_P (insn)) && (Pmode == SImode)")
  ...
  (0 "(SIBLING_CALL_P (insn)) && (Pmode == DImode)")
  ...
  (0 "(TARGET_VZEROUPPER && SIBLING_CALL_P (insn)) && (Pmode == DImode)")
  (0 "(DImode != DImode || TARGET_64BIT)
   && SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH
   && !(TARGET_INTER_UNIT_CONVERSIONS || optimize_function_for_size_p (cfun))
   && reload_completed
  ...
  (-1 "(TARGET_SSE2 && !(MEM_P (operands[0]) && MEM_P (operands[1]))) && (TARGET_AVX)")
  ...
  (-1 "(TARGET_SSE && !(MEM_P (operands[0]) && MEM_P (operands[1]))) && (TARGET_SSE2)")
  ...
  (-1 "ZERO_EXTEND == ZERO_EXTEND ? TARGET_SSE2 : TARGET_SSE4_1")
  (-1 "(optimize_function_for_size_p (cfun)
    || !TARGET_PARTIAL_FLAG_REG_STALL
    || (operands[2] == const1_rtx
	&& (TARGET_SHIFT1
  ...
  (-1 "(optimize_function_for_size_p (cfun)
   ...
   && ix86_match_ccmode (insn, CCGOCmode)
   && ix86_binary_operator_ok (ASHIFTRT, SImode, operands)")
  (0 "(TARGET_SSE || TARGET_3DNOW_A) && (Pmode == DImode)")
  (0 "TARGET_64BIT && ix86_match_ccmode (insn, CCNOmode)
   && !(MEM_P (operands[0]) && MEM_P (operands[1]))")
  (0 "TARGET_64BIT && ix86_match_ccmode (insn, CCNOmode)
  ...
  (-1 "(X87_FLOAT_MODE_P (GET_MODE (operands[1]))
   ...
   && !(SSE_FLOAT_MODE_P (GET_MODE (operands[1]))
	 && (TARGET_64BIT || DImode != DImode))
   && can_create_pseudo_p ()) && ( 1)")
  (0 "((TARGET_VZEROUPPER && SIBLING_CALL_P (insn)) && (Pmode == DImode)) && ( reload_completed)")
  ...
  (-1 "SIGN_EXTEND == ZERO_EXTEND ? TARGET_SSE2 : TARGET_SSE4_1")
  ...
  (0 "TARGET_LP64 && ix86_check_movabs (insn, 0)")
  (-1 "TARGET_80387 && X87_ENABLE_ARITH (DFmode)
   && COMMUTATIVE_ARITH_P (operands[3])
   && !(MEM_P (operands[1]) && MEM_P (operands[2]))")
  (-1 "TARGET_AVX
  ...
  (-1 "(!SIBLING_CALL_P (insn)) && (Pmode == SImode)")
  (0 "TARGET_64BIT
   && (optimize_function_for_size_p (cfun)
       || !TARGET_PARTIAL_FLAG_REG_STALL
       || (operands[2] == const1_rtx
  ...
  (-1 "(((TARGET_USE_BT || optimize_function_for_size_p (cfun))
   && (INTVAL (operands[3]) & (GET_MODE_BITSIZE (DImode)-1))
      == GET_MODE_BITSIZE (DImode)-1) && (TARGET_64BIT)) && ( 1)")
  (-1 "TARGET_SSE2 && TARGET_AVOID_VECTOR_DECODE && optimize_insn_for_speed_p ()")
  ...
  (-1 "TARGET_AVX2
   && (GET_MODE_NUNITS (V8SImode)
       == GET_MODE_NUNITS (V16HImode))")
  (-1 "TARGET_3DNOW || TARGET_PREFETCHW")
  (-1 "((TARGET_80387
     && X87_ENABLE_FLOAT (SFmode, DImode)
     && (!((DImode != DImode || TARGET_64BIT)
	   && SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH)
  ...
  (-1 "(TARGET_SSE && !(MEM_P (operands[0]) && MEM_P (operands[1]))) && (TARGET_AVX)")
  (-1 "ix86_match_ccmode (insn, CCGOCmode)
   && ix86_binary_operator_ok (MINUS, QImode, operands)")
  (-1 "TARGET_80387 && X87_ENABLE_ARITH (DFmode)
   && !(TARGET_SSE2 && TARGET_SSE_MATH)
  ...
  (-1 "TARGET_AVX2 && ix86_binary_operator_ok (PLUS, V32QImode, operands)")
  ...
  (-1 "(TARGET_USE_FANCY_MATH_387
   ...
   || (SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH
       && !flag_trapping_math && !flag_rounding_math)")
  (0 "TARGET_LP64 && ix86_check_movabs (insn, 1)")
